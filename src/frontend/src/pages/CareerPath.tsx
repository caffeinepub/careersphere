            ...
            <div className="grid md:grid-cols-2 gap-6 animate-fade-in">
              {careers.map((item, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="bg-card rounded-2xl p-6 border border-border hover:shadow-soft-lg transition-all relative"
                  >
                    <div className="flex justify-between items-start mb-4">
                      <h3 className="text-xl font-semibold text-primary">{item.career}</h3>
                      <button
