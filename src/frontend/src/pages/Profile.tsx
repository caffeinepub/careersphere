...
import { User, Award, Heart, Loader2, LogOut, Calendar } from 'lucide-react';
        ...
        <div className="max-w-5xl mx-auto space-y-8">
          ...
          <div className="bg-card rounded-2xl p-8 border border-border shadow-soft-lg animate-fade-in">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-border hover:bg-accent transition-all"
              >
          ...
          <div className="bg-card rounded-2xl p-8 border border-border shadow-soft animate-fade-in">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl font-semibold">Stream Selector Results</h2>
            </div>
              ...
              <div className="space-y-4">
                <div className="bg-gradient-to-r from-primary/10 to-secondary/10 rounded-xl p-6 border border-primary/20">
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      <p className="text-sm text-muted-foreground mb-1">Recommended Stream</p>
          ...
          <div className="bg-card rounded-2xl p-8 border border-border shadow-soft animate-fade-in">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl font-semibold">Bookmarked Items</h2>
            </div>
                  ...
                  {bookmarkedCareers.map((career) => (
                    ...
                    >
                      <div className="flex items-start justify-between mb-2">
                        <h3 className="font-semibold text-primary">{career.title}</h3>
